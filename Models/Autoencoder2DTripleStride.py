...
class Autoencoder2DTripleStride(nn.Module):

    def __init__(self):
        super(Autoencoder2DTripleStride, self).__init__()
        ...
        self.decoder = nn.Sequential(
            nn.ConvTranspose2d(1,64, (3,3), stride=(1,2)),
            nn.ReLU(),
            nn.BatchNorm2d(64),
