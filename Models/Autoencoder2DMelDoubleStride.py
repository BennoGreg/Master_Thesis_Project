...
class Autoencoder2DMelDoubleStride(nn.Module):

    def __init__(self):
        super(Autoencoder2DMelDoubleStride, self).__init__()
        self.encoder = nn.Sequential(
            ...
            nn.Conv2d(128, 64, (3, 3), stride=(1,2),padding=(1,1)),
            nn.ReLU(True),
            nn.BatchNorm2d(64),
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose2d(256,225, (3,5),stride=(1,2), padding=(1,1)),
            nn.ReLU(),
            nn.BatchNorm2d(225),

            nn.ConvTranspose2d(225,1, (1,2), stride=(1,1)),
